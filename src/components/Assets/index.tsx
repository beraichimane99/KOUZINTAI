...
import FishI from "../../img/fish.png";
import CouscousI from "../../img/couscous.png";
import RfissaI from "../../img/rfissa.png";
import PouletI from "../../img/djaj.png";
import seffaI from "../../img/seffa.png";
import testI from "../../img/test.jpg";
import teteteI from "../../img/tetete.png";



// Exports
export const tetete = teteteI
export const seffa = seffaI
export const test = testI
export const Poulet = PouletI
export const Couscous = CouscousI
export const Rfissa = RfissaI
